...
later, the cycle runs end-to-end --- awiesm3 year $\to$ PISM decade $\to$ awiesm3 year on
the changed mesh --- and a 10-year/100-year production run is underway. The whole campaign
is one chronological narrative in \S\ref{sec:bugs}; the current state, including the open
Ross-front item of the second increment and the summer melt-back bias, is in
\S\ref{sec:state}.
\end{abstract}
...
\subsubsection*{New open item: the second increment (Ross front)}
