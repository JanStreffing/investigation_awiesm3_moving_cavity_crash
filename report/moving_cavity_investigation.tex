...
\item \textbf{\code{voskin:282} --- dormant, not fixed.} Last fired in \code{repro\_movcav45} at
  year~1919 (\code{voskin\_mod.F90:318}); 38 cycles clean since, and never in \code{fgdbg02}.
  Instrumentation is in place (\S\ref{sec:voskin-inventory}).
